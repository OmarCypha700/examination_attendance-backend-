...
urlpatterns = [
    ...
    path("courses/template/",                           views.CourseTemplateView.as_view(),       name="course-template"),

    # ── Exam Sessions ─────────────────────────────────────────────────────────
    path("exam-sessions/",                              views.ExamSessionListCreateView.as_view(), name="session-list"),
    path("exam-sessions/export/",                       views.SessionExportView.as_view(),         name="session-export"),
    path("exam-sessions/import/",                       views.SessionImportView.as_view(),         name="session-import"),
